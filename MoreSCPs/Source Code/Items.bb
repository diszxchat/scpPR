...
Function InitItemTemplates()
	...
	it = CreateItemTemplate("SCP-005", "scp005", "MoreSCPs\GFX\items\untitled2.b3d", "MoreSCPs\GFX\items\INV005.jpg", "", 0.0004,"MoreSCPs\GFX\items\keyB_tx.jpg")	
	...
	it = CreateItemTemplate("Document SCP-1074", "paper", "GFX\items\paper.x", "GFX\items\INVpaper.jpg", "MoreSCPs\GFX\items\doc1074.jpg", 0.003) : it\sound = 0
	it = CreateItemTemplate("Document Unknown", "paper", "GFX\items\paper.x", "GFX\items\INVpaper.jpg", "MoreSCPs\GFX\items\doc1074_Joke.jpg", 0.003) : it\sound = 0	
	it = CreateItemTemplate("SCP-1074 Containment Notice", "paper", "GFX\items\paper.x", "GFX\items\INVpaper.jpg", "MoreSCPs\GFX\items\doc_arce.jpg", 0.003) : it\sound = 0
	it = CreateItemTemplate("Document SCP-038", "paper", "GFX\items\paper.x", "GFX\items\INVpaper.jpg", "MoreSCPs\GFX\items\doc038.jpg", 0.003) : it\sound = 0		
	...
	it = CreateItemTemplate("Note from Maynard", "paper", "GFX\items\paper.x", "GFX\items\INVnote.jpg", "MoreSCPs\GFX\items\maynard005note.png", 0.0025) : it\sound = 0
	it = CreateItemTemplate("Document SCP-409", "paper", "GFX\items\paper.x", "GFX\items\INVpaper.jpg", "MoreSCPs\GFX\items\doc409.jpg", 0.003) : it\sound = 0	
	it = CreateItemTemplate("Document SCP-005", "paper", "GFX\items\paper.x", "GFX\items\INVpaper.jpg", "MoreSCPs\GFX\items\doc005.jpg", 0.003) : it\sound = 0	
	it = CreateItemTemplate("Document SCP-009", "paper", "GFX\items\paper.x", "GFX\items\INVpaper.jpg", "MoreSCPs\GFX\items\doc009.jpg", 0.003) : it\sound = 0	
				
	it = CreateItemTemplate("Binoculars", "binocular", "MoreSCPs\GFX\items\binoculars.b3d", "MoreSCPs\GFX\items\INVbinoculars.jpg", "", 0.03) : it\sound = 2	
	...
	it = CreateItemTemplate("Key","misc","MoreSCPs\GFX\items\untitled2.b3d", "MoreSCPs\GFX\items\INV005.jpg", "", 0.0004,"MoreSCPs\GFX\items\keyB_tx.jpg")
