...
;							EndIf
			...
			Case "room2test1074"
				...
				If PlayerRoom=e\room Then
					If e\Sound=0 Then e\Sound=LoadSound_Strict("MoreSCPs\SFX\music\Blue Feather.ogg") ;tell me if you can find a better alternative to this					
			...
			Case "room409"
				...
				If PlayerRoom = e\room Then
					If EntityY(Collider) < -2848*RoomScale Then
						...
						If Music(24)=0 Then Music(24) = LoadSound_Strict("MoreSCPs\SFX\Music\SCP-409 Ambience.ogg") 
						ShouldPlay = 24
					EndIf
					;If EntityY(Collider,True)<-4.0 Then
			...
			Case "room009"
				...
				If e\Sound=0 Then LoadEventSound(e,"MoreSCPs\SFX\light_blink.ogg")
				...
				If e\EventState>=4290.0 And e\EventState3=1.0 Then
			        PlaySound_Strict LoadTempSound("MoreSCPs\SFX\ice-cracking.ogg")
					PlaySound TempSound
					e\EventState3=2.0
				EndIf
